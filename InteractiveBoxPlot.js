    ...
    .on("mouseover", (event) => {
      tooltip.style("display", "block")
        ...
        .html(`
          ...
          <strong>Min:</strong> ${min.toFixed(1)}<br>
          <strong>Q1:</strong> ${q1.toFixed(1)}<br>
          <strong>Median:</strong> ${median.toFixed(1)}<br>
          <strong>Q3:</strong> ${q3.toFixed(1)}<br>
          <strong>Max:</strong> ${max.toFixed(1)}
        `);
    })
    .on("mouseout", () => {
